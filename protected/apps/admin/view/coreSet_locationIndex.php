...
<center>
    ...
    $content[] = commonTableAddContent('input','text','location',$req['locationName'],'--默认不选择归属就是主类');
    $content[] = optionTableAddContent('locationTid',$contentArray['location'],'','',$req['tid']);
    ...
    if(isset($searchInfo) and is_array($searchInfo)){
        ...
        <tr>
            <td>序号</td>
            <td>主地点<span id="op" ><img width="15" height="15" src="__PUBLICAPP__/images/plus.gif"></span><span id="cl"><img  width="15" height="15"src="__PUBLICAPP__/images/minus.gif"></span></td>
            <td>具体地点</td>
            <td>地点描述</td>
            <td>操作</td>
            <td>操作</td>
...
<?php
        ...
        foreach($searchInfo as $value){
            ...
            $urlEdit = url('coreset/locationEdit')."&id=".$value['id'];
        ...
        ";
            echo "<td>$i</td>
        ";
        echo "<td>".$value['locationName']."<span class=\"fold\" ></span></td>
        ";
            echo "<td>".$value['subLocationName']."</td>
            ";
