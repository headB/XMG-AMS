...
//设置button效果，开始计时
            ...
            $.ajax({
                ...
                data: {'email': x.value,"operate":'adminRegister'},
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" value="<?php echo $req['username']; ?>" class="form-control" name="username"
                                   data-bv-remote="true" data-bv-remote-url="<?php echo url('register/ajaxReturn')."&query=adminname"; ?>" data-bv-remote-message="用户名已经注册过啦！！是哪个混蛋呢？"
