...
<center>
    ...
    $content[] = commonTableAddContent('input','text','typename',$req['typename'],'--计量单位名称--');
    $content[] = commonTableAddContent('input','text','description',$req['description'],'-计量单位描述--');
    ...
    if(isset($searchInfo) and is_array($searchInfo)){
        ...
        $urlDelete = url('coreSet/measureDelete');
        $urlEdit = url('coreSet/measureEdit');
