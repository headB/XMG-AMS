            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form id="defaultForm" method="post" class="form-horizontal" action=""
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">想设置的WIFI的登陆账号</label>
                        <div class="col-lg-5">
                            <input type="text" value="<?php echo $req['username']; ?>" class="form-control" name="username"
                                   data-bv-remote="true" data-bv-remote-url="<?php echo url('register/ajaxReturn')."&query=name"; ?>" data-bv-remote-message="用户名已经注册过啦！！是哪个混蛋呢？"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">想设置的WIFI登陆密码</label>
                        <div class="col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">再次确认你WIFI登陆密码</label>
                        <div class="col-lg-5">
