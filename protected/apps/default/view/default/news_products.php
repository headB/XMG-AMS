                ...
                <ul class="list-media list-underline">
                    ...
                    <li>
                        <div class="media media-x">
                            {if $vo['picture'] && $vo['picture']!='NoPic.gif'}<a class="float-left" title="{$vo['title']}" href="{$vo['url']}" target="_blank"><img style="width:135px;height: 100px;" src="{$vo['picturepath']}" class="radius" alt="{$vo['title']}"></a>{/if}
